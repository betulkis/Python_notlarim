...
plt.plot(x,y,"o--r")  # o--r matplotlib pyplot google. o marker.--  çizgi tipi . r çizgi rengi [marker,line,color]
plt.axis([0,6,0,20])  # x  min 0 max6  y min 0 max 20
...
x = np.linspace(0,2,100) # 0 ile 2 arası 100 eşit parçaya bölsün

# tek grafikte 3 çizgi
plt.plot(x, x, label="linear",color="red")
plt.plot(x, x**2, label="quadratic",color="yellow")  #karesi
plt.plot(x, x**3, label="cubic",color="green")  #küpü
